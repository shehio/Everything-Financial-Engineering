...
- [Transform both sides](https://en.wikipedia.org/wiki/Data_transformation_(statistics))
...
- [Least Trimmed Squares](https://en.wikipedia.org/wiki/Least_trimmed_squares)
